...
pub fn request_headers_from_server(url: &Url, timeout: u64, ua: &str) -> Fallible<HeaderMap> {
    let resp = Client::new()
        .get(url.as_ref())
...
pub fn prep_headers(fname: &str, resume: bool, user_agent: &str) -> Fallible<HeaderMap> {
